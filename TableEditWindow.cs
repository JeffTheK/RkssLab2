...
namespace Lab2
{
    ...
    public class TableEditWindow<T> : VBox where T : class
    {
        ...
        protected CarSalonContext carSalonContext;
        ...
        public TableEditWindow(CarSalonContext carSalonContext, DbSet<T> dbset, ErrorsWindow errorsWindow, int rows, List<EntryType> entryTypes, List<string> defaultValues) : base(false, 6)
        {
            this.carSalonContext = carSalonContext;
            this.dbset = dbset;
